...
res_99=run_models(X_train_99,X_test_99,y_train,y_test)
...
res_95=run_models(X_train_95,X_test_95,y_train,y_test)
...
sfs=SequentialFeatureSelector(model_sfs,n_features_to_select=5,direction="forward",cv=2)
...
res_sfs=run_models(X_train_sfs,X_test_sfs,y_train,y_test)
...
try:
    ...
    shap.summary_plot(shap_values, X_test_95)
...
try:
    ...
    explainer=LimeTabularExplainer(X_train_95,mode="classification")

    exp=explainer.explain_instance(X_test_95[0],rf.predict_proba)
